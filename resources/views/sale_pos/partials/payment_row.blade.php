<div class="col-md-12">
    <div class="box box-solid payment_row bg-lightgray">
        ...
        @php
            ...
            $show_in_pos = '';
            if (!empty($pos_settings['enable_cash_denomination_on']) && ($pos_settings['enable_cash_denomination_on'] == 'all_screens' || $pos_settings['enable_cash_denomination_on'] == 'pos_screen')) {
                $show_in_pos = true;
            }
        @endphp
